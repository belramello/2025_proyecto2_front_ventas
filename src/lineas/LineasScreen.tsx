...
const LineasScreen = () => {
  ...
  const [lineaAEliminar, setLineaAEliminar] = useState<{ id: number; nombre: string } | null>(null);
    ...
    <div className="container-fluid mt-3 px-4">
      <div className="lineas-header-container">
        <div>
          ...
          <p className="text-muted mb-0">Gestioná las líneas de productos o servicios.</p>
        </div>
                ...
                <tr key={linea.id}>
                  ...
                  <td>
                    <PrimaryButton
                      label="ELIMINAR"
                      variant="danger"
                      onClick={() => solicitarEliminacion(linea.id, linea.nombre)}
                    />
                  </td>
                </tr>
              ))}
