...
const ProveedorScreen = () => {
  ...
  return (
    <div className="container-fluid mt-3 px-4">
      ...
      <PermissionGuard requiredPermissions={Permisos.VER_PROVEEDOR}>
              ...
              <tbody>
                {proveedores.map((prov) => (
                  <tr key={prov.id}>
                    ...
                    <PermissionGuard
                      requiredPermissions={Permisos.ELIMINAR_PROVEEDOR}
                    >
                      <td>
                        <PrimaryButton
                          label="ELIMINAR"
                          variant="danger"
                          onClick={() =>
                            solicitarEliminacion(prov.id, prov.nombre)
                          }
                        />
                      </td>
                    </PermissionGuard>
      ...
      {proveedorAEliminar && (
        <PermissionGuard requiredPermissions={[Permisos.ELIMINAR_PROVEEDOR]}>
          <ConfirmModal
            show={modalVisible}
